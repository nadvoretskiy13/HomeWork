...
1. Ссылка на программу и отчёт со скриншотами в репозитории github;
2. Архив с программой и отчётом со скриншотами выполнения задач.
В отчёте представить следующие скриншоты:
- установка git (если гит устанавливался на систему),
- создание ветки git,
- структура программы по папкам,
- выгрузка программы в удаленный репозиторий,
- код дополнительного задания и скриншот выполнения кода (в случае,
